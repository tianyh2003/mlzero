...
public:
    ...
    ICudaEngine* createEngine(IBuilder* builder, IBuilderConfig* config)
    {
        ...
        IConvolutionLayer* conv2 = network->addConvolutionNd(*relu1->getOutput(0), NUM_CHANNELS, DimsHW{3, 3}, weightMap["conv2.weight"], weightMap["conv2.bias"]);
        assert(conv2);
        ...
        IConvolutionLayer* conv3 = network->addConvolutionNd(*relu2->getOutput(0), NUM_CHANNELS, DimsHW{3, 3}, weightMap["conv3.weight"], weightMap["conv3.bias"]);
        assert(conv3);
        ...
        IConvolutionLayer* conv4 = network->addConvolutionNd(*relu3->getOutput(0), NUM_CHANNELS, DimsHW{3, 3}, weightMap["conv4.weight"], weightMap["conv4.bias"]);
        assert(conv4);
